...
<section class="my-5">
    <div class="py-3">
       <strong><h2 class="text-center">SIGN UP!</strong></h2>
 </div>
 ...
 <div>
   ...
   <div class="form-group">
       ...
       <input type="text" name="username" placeholder="Username" data-form-field="username" class="form-control" value="" id="name-form8-u"> 
     </div>
     <div class="form-group">
       <label><h3>Email</h3></label>
       <input type="email" name="email" placeholder="Email" data-form-field="email" class="form-control" value="" id="email-form8-u"> 
     </div>
     <div class="form-group">
       <label><h3>Password</h3></label>
       <input type="text" name="password" placeholder="Password" data-form-field="password" class="form-control" value="" id="name-form8-u"> 
    </div>
        <div class="col-auto mbr-section-btn align-center"><button type="submit" class="btn btn-primary btn-block">Create Account</button></div>
        <p class="text-center"><h3>Have an account already?<a href="login.php">Log In</a></h3></p>
    </div>
 </div>
</section>
